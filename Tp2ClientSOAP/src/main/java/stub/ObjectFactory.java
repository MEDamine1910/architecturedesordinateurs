...
public class ObjectFactory {
    ...
    private static final QName _ListStudents_QNAME = new QName("http://serveur/", "listStudents");
    private static final QName _ListStudentsResponse_QNAME = new QName("http://serveur/", "listStudentsResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://serveur/", name = "listStudents")
     ...
     */
    @XmlElementDecl(namespace = "http://serveur/", name = "listStudentsResponse")
