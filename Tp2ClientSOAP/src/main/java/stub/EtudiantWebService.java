 ...
 * 
 */
@WebService(name = "EtudiantWebService", targetNamespace = "http://serveur/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface EtudiantWebService {
    ...
    @Action(input = "http://serveur/EtudiantWebService/listStudentsRequest", output = "http://serveur/EtudiantWebService/listStudentsResponse")
