...
public final class UserGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<User.LoginRequest,
      User.LoginResponse> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "login",
      requestType = User.LoginRequest.class,
      responseType = User.LoginResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<User.LoginRequest,
      User.LoginResponse> getLoginMethod() {
    io.grpc.MethodDescriptor<User.LoginRequest, User.LoginResponse> getLoginMethod;
    if ((getLoginMethod = UserGrpc.getLoginMethod) == null) {
      synchronized (UserGrpc.class) {
        if ((getLoginMethod = UserGrpc.getLoginMethod) == null) {
          UserGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<User.LoginRequest, User.LoginResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  User.LoginResponse.getDefaultInstance()))
  ...
  public static abstract class UserImplBase implements io.grpc.BindableService {
    ...
    public void login(User.LoginRequest request,
                      io.grpc.stub.StreamObserver<User.LoginResponse> responseObserver) {
  ...
  public static final class UserBlockingStub extends io.grpc.stub.AbstractStub<UserBlockingStub> {
    ...
    /**
     */
    public User.LoginResponse login(User.LoginRequest request) {
  ...
  public static final class UserFutureStub extends io.grpc.stub.AbstractStub<UserFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<User.LoginResponse> login(
